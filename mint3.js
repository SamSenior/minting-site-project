...
import { initOnboard } from "./mint-site-project/utils/onboard";
import { useConnectWallet, useSetChain, useWallets } from "@web3-onboard/react";
import { config } from "./mint-site-project/dapp.config";
import {
  getTotalMinted,
  getMaxSupply,
  isPausedState,
  ...
  presaleMint,
  publicMint,
} from "./mint-site-project/utils/interact";
          ...
          <div className="relative z-1 md:max-w-3xl w-full bg-gray-900/90 filter backdrop-blur-sm py-4 rounded-md px-2 md:px-10 flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
              <div className="relative w-full">
                <div className="font- z-10 absolute top-2 left-2 opacity-80 filter backdrop-blur-lg text-base px-4 py-2 bg-black border border-brand-purple rounded-md flex items-center justify-center text-white font-semibold">
                  <p>
              ...
              <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                ...
                {wallet ? (
                  <button
                    ...
                    } font-kaushan mt-12 w-full px-6 py-3 rounded-md text-2xl text-white  mx-4 tracking-wide uppercase`}
                  ...
                  <button
                    className="font-kaushan mt-12 w-full bg-gradient-to-br from-brand-purple to-brand-pink shadow-lg px-6 py-3 rounded-md text-2xl text-white hover:shadow-pink-400/50 mx-4 tracking-wide uppercase"
                    onClick={() => connect()}
                  >
                    Connect Wallet
                  </button>
            ...
            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
              <h3 className="font-kaushan text-2xl text-brand-pink uppercase mt-6">
                Contract Address
              </h3>
              <a
